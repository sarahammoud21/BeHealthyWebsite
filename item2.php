...
$viewits = "SELECT* FROM `item` WHERE ID=2";
...
?>
    ...
    <section id="ItemProfile">
        <div class="content">
            ...
            <p><img src="<?php echo $row['logo']; ?> " width="200" height="200" alt="picture of the LeanMeals resturant">
            </p>
...
?>
            <div style="margin-top: 10px">
                <div class="rating" style="width:<?php echo $rate_bg; ?>%" />
        ...
        <p><a href="https://www.instagram.com/lean_meals/" class='fa fa-instagram' style='color:#b93cd3'></a>
        </p>
...
$viewr = "SELECT* FROM `review` WHERE item_id=2";
                ...
                <div class="box-top">
                    <div class="profile">
                        <div class="profile-img">
                            <img src="user3.jfif" width="40" height="40" alt="picture of user">
                        </div>
                        <div class="user-name">
                            <strong>
                                <?php echo $row['name']; ?>
        ...
        <div class="box-handel">
            <div class="box">
                <div class="box-top">
                    <div class="profile">
                        <div class="profile-img">
                            <img src="user4.jfif" width="40" height="40" alt="picture of user">
                        </div>
                        <div class="user-name">
                            <strong>
                                <?php echo $roww['name']; ?>
            ...
            <div class="popup">
                ...
                <div class="content">
                    <form method="POST" action='' class="form-container">
                        ...
                        <input type="text" placeholder="Type your comment here.." name="comment" required>
